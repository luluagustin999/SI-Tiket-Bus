<div class="container my-4">
	<div class="card">
        <div class='card-header bg-primary text-white'><b>INFO PERJALANAN</b></div>
    ...
    <div class='card'>
            <div class='card-header bg-primary text-white'><b>Detail Penumpang</b></div>
            <div class='card-body'>
    ...
    <hr>
        <div class='card'>
            <div class='card-header bg-primary text-white'><b>Detail Pemesan</b></div>
            <div class='card-body'>
                <div class='row'>
                    <div class='col-md-4'>
