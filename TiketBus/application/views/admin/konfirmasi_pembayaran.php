...
<body>
	...
	<div class="container-fluid my-4">
        <h4 class="text-center">Daftar Pelanggan Yang Mengirim Bukti Pembayaran</h4>
        <div class="card">
            <div class="card-body">
                    ...
                    <table class="table table-striped table-bordered datatables">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a onclick='return confirm("Yakin Ingin Verfikasi No Pembayaran <?= $li->no_pembayaran ?> ? ")' href="<?= base_url('Verifikasi/'.$li->id) ?>" class="btn btn-success">Konfirmasi</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
